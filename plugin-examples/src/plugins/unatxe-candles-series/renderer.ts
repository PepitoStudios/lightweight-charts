...
import { ICustomSeriesPaneRenderer, PaneRendererCustomData, PriceToCoordinateConverter } from '../../../../lib/dev/src/model/icustom-series';
import { Range } from 'lightweight-charts/model/time-data';
import { Time } from 'lightweight-charts/model/horz-scale-behavior-time/types';
import {
